#========================================================
#+++++++++++++++++  测试用例信息   ++++++++++++++++
# 用例  ID: FM_GRPC_Account_SendActiveSMS_005_002
# 用例标题: 注册发送短息验证码
# 预置条件: 
#   
# 测试步骤:
...
class SendActiveSMS(unittest.TestCase):
    def setUp(self):
        #连接account测试服务器
    ...
    def test_SendActiveSMS(self):
        #发送验证码到手机
        sendActivationEmail = self.stub.SendActiveSMS(account_pb2.SendSMSRequest(Phone = userData['AccountMobile'], ActiveCode = userData['ActivationCode']))
        #断言验证码发送成功，返回0
