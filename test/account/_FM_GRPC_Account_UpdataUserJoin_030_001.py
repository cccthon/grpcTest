#========================================================
#+++++++++++++++++  测试用例信息   ++++++++++++++++
# 用例  ID: FM_GRPC_Account_UpdateUserJoin_030_001
# 用例标题: 更新用户
# 预置条件: 
#   
# 测试步骤:
...
class UpdateUserJoin(unittest.TestCase):
    def setUp(self):
        #连接account测试服务器
    ...
    def test_UpdateUserJoin(self):
        UpdateUser = self.stub.UpdateUserJoin(account_pb2.UpdateUserJoinRequest(User = account_pb2.User(AccountEmail = userData['AccountEmail'] ,UserPassword = userData['UserPasswd'])))
        print(UpdateUser)
