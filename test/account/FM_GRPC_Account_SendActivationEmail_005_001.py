#========================================================
#+++++++++++++++++  测试用例信息   ++++++++++++++++
# 用例  ID: FM_GRPC_Account_SendActivationEmail_005_001
# 用例标题: 通过邮件验证新注册的账号
# 预置条件: 
#   1.已经存在昵称为：account_test的账号
# 测试步骤:
#   1.调用接口：SendActivationEmail，发送验证码到邮箱
#   2.通过GetActivationByObj获取验证码
#   3.使用接口ValidateEmailLink激活账号
# 预期结果:
#   3.测试账号激活成功。激活返回值为：0
# 脚本作者: shencanhui
# 写作日期: 20170815
...
class SendActivationEmail(unittest.TestCase):
    def setUp(self):
        #连接account测试服务器
